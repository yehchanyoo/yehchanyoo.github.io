...
이 페이지에서는 제가 워싱턴 대학교와 UC 버클리에서 학생으로 재학하는 동안 수행한 연구를 다룹니다. (제 커리어에 대한 자세한 내용은 [LinkedIn 프로필](https://www.linkedin.com/in/yehchanyoo/)이나 [이력서](</attachments/류예찬 이력서(2026년 7월 7일 버전).pdf>)를 참고해주세요!)
...
*2023년 10월 9일 발표* ([링크](https://docs.google.com/presentation/d/16ASxBvUo6afS52CQQReqnSq4RH7ThPBqtJDuuHEZCwE/edit?usp=sharing), [PDF 링크](</attachments/2023/CR4CR Autograder Model Presentation (Yehchan Yoo, October 9, copy).pdf>))

<figure>
  <img src="/attachments/2023/asag_roberta_image.jpeg">
  <figcaption>ChatGPT로 생성한 설명용 이미지. 시각적 이해를 돕기 위한 용도로만 사용되었으며, 최종 발표문에는 포함되지 않았습니다.</figcaption>
</figure>
...
이 발표에서는 UC 버클리 교육대학 내 [버클리 교육평가연구센터](https://bearcenter.berkeley.edu/)에서 CR4CR 프로젝트의 연구 보조원으로서 수행한 연구 결과를 공유합니다. 프로젝트의 목표는 최첨단 대규모 언어 모델인 RoBERTa를 단답형 답안 자동 채점에 적용하는 것을 탐구하는 것이었으며, 이는 교육 평가의 확장성에 중요한 의미를 갖습니다. 데이터 수집, 모델 학습, 테스트 세트에 대한 엄밀한 평가를 통해, 단답형 답안 평가 시 75%의 테스트 정확도를 달성하는 채점 시스템을 개발하였습니다. 이 발표에서는 방법론, 결과 및 연구의 한계를 논의하여, 교육 응용 분야에서 RoBERTa와 같은 강력한 딥러닝 모델 활용의 가능성과 과제에 대한 이해를 심화합니다.

***

## [CR4CR GeoGebra 대화형 증명 발표](https://docs.google.com/presentation/d/1FaPVOUcs32gKcQhHg7CvDcx2DdeiTRnhAd6rpwH8K5Y/edit?usp=sharing)

*2023년 10월 6일 발표* ([링크](https://docs.google.com/presentation/d/1FaPVOUcs32gKcQhHg7CvDcx2DdeiTRnhAd6rpwH8K5Y/edit?usp=sharing), [PDF 링크](</attachments/2023/CR4CR GeoGebra Interactive Proof Presentation.pdf>))
...
<figure>
  ...
  <figcaption>GeoGebra 데모 실행 모습을 보여주는 애니메이션 이미지</figcaption>
</figure>
...
UC 버클리 교육대학 내 [버클리 교육평가연구센터](https://bearcenter.berkeley.edu/)에서 진행한 이 발표에서는 GeoGebra를 활용한 기존 작업과 대화형 교육 자료 개발에 이 프로그램을 활용할 가능성에 대해 논의합니다. GeoGebra는 기하학과 대수학의 동적 시각화를 생성하고 공유할 수 있는 무료 교육용 소프트웨어입니다. GeoGebra 시각화 개발 과정과 효과적인 개발을 위한 팁을 공유하며, 전체 조회수 15,000회 이상을 기록한 GeoGebra 애플릿도 소개합니다.
